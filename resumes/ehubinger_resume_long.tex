...
\section{Programming Languages}
  ...
  \textbf{Proficient} \\
  \verb|Go, JavaScript, C++, Haskell, MATLAB|
  \end{minipage}
  \begin{minipage}[t]{.32\textwidth}
  \textbf{Knowledgeable} \\
  \verb|R, Java, Mathematica|
  \end{minipage}

\section{Summary}
  Four summers of professional software engineering experience at Google, Yelp, and Ripple. Created two major open-source projects, the Coconut programming language and Undebt, which together have over 2,000 stars on GitHub. Dean's list student majoring in mathematics and computer science at Harvey Mudd College.
...
$\bullet$ Worked as a Launch Coordination Engineer developing the software Google uses to perform production reviews of new launches. \\
$\bullet$
...
$\bullet$ Rewrote Yelp's system for running large batch data processing operations in EMR. \\
...
Developed a program to perform image steganography using the discrete wavelet transform method. Written in Coconut. \\
...
\section{Open Source Contributions}
  \textbf{Pre-Commit}
  Fixed an issue that prevented installation on Windows machines. \\
  \textbf{Conda}
  Fixed an issue that prevented installation of certain PyPI packages. \\
  \textbf{Jupyter (IPython)}
  Fixed an issue that broke custom syntax highlighting. \\
  \textbf{Python Typeshed}
  Added type annotations for standard library module \verb|future_builtins|. \\
  \textbf{PyParsing}
...
\section{Relevant Courses}
  ...
  \hfill Fall 2016 \\
  $\bullet$ Working directly with Prof. Chris Stone on Coconut development and research. \\
