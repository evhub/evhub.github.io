...
\section{Programming Languages}
  ...
  \textbf{Proficient} \\
  \verb|Haskell, C++, JavaScript, CoffeeScript, MATLAB|
  \end{minipage}
...
\section{Summary}
  Three summers of professional software engineering experience, one at Yelp and two at Ripple. Created two major open-source projects, the Coconut programming language and Undebt, which together have over 2,000 stars on GitHub. Dean's list student majoring in mathematics and computer science at Harvey Mudd College.

\section{Work Experience}
\textbf{Computer Science Grader and Tutor}
\hfill January - May 2016; September 2016 - Present \\
\textbf{Harvey Mudd College, Claremont, CA} \\
$\bullet$ Currently grading and tutoring for Principles and Practices of Computer Science. \\
$\bullet$ Previously graded and tutored for Computer Science for Insight. \\
