...
\begin{abstract}
We analyze the history of arguments for and against the Everett interpretation of quantum mechanics, from Everett's original paper to modern alternatives, and conclude that Everett's theory of the universal wave function is the most probable interpretation available. \hyperref[sec:everett]{Section~\ref*{sec:everett}} provides a concise definition of the Everett interpretation based on the idea of accepting the physical reality of the wave function, and \autoref{sec:math} provides derivations of wave function collapse, random measurement, and the Born rule from that definition. \hyperref[sec:args]{Section~\ref*{sec:args}} addresses concerns with the Everett interpretation's falsifiability and simplicity, and provides empirical and theoretical arguments for why the Everett interpretation is actually the simplest, most empirically-validated interpretation available. Finally, \autoref{sec:alts} analyzes the alternatives of decoherence without Everett, consistent histories, and pilot wave theory, and finds reasons to reject each one in favor of the Everett interpretation.
\end{abstract}
...
\begin{enumerate}[1.]
\item the wave function obeys the standard, linear, deterministic Schrodinger wave equation (the relativistic variant, to be precise) \textit{at all times}, and
