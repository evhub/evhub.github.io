...
\usepackage[margin=.845in]{geometry}
...
We seek to present and defend the view that the interpretation of quantum mechanics is no more complicated than Einstein's interpretation of General Relativity: ``The theory is correct.''\cite{famousquotes} The view which holds that the mathematical formalism of quantum mechanics---without any additional postulates---is a complete description of reality is known as the Everett interpretation. We seek to defend the Everett interpretation of quantum mechanics as the most probable interpretation available. To accomplish this task, we analyze the history of the Everett interpretation, provide mathematical backing for its assertions, respond to criticisms that have been leveled against it, and compare it to other modern alternatives.
\end{abstract}
